...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        @endif
        <form id='editProfileForm' method='POST'  action='{{url('/admin/settings/profile/save')}}' class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="name" type="text" placeholder="Name" class="form-control" name="name" value="{{isset(Auth::guard('admin')->user()->name) ? Auth::guard('admin')->user()->name : old('name')}}" autofocus>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    @if(isset(Auth::guard('admin')->user()->id))
                        <img src="{{ config('aws.aws_s3_url').'/uploads/admin/profile-pic/'.Auth::guard('admin')->user()->id.'/thumbnails/200x200/'.Auth::guard('admin')->user()->profile_pic.'?'.time() }}" border="0"  class="img-rounded" align="center" />
                    @endif
                </div>
            </div>
